...
label_coarse_path = '../testdata/label_refine/';
% Original training image label path (fine data)
label_path = '../traindata/Label1024Full/';
...
% Order data path
% Order original data
path_proposal_order = '../testdata/order/';
% Order data network output
path_proposal_score = '../result/order/data/';

% Retrieved segments before transformation
path_response_proposal = '../testdata/transform/transform_1024/';
% Segments after transformation
path_transferred = '../result/transform/transform_1024/';

save_response_path = '../testdata/synthesis/transform_order_1024/';
save_response_img = '../testdata/synthesis/transform_order_1024_canvas/';
